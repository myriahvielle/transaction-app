...
class TransactionController extends Controller
{
    ...
    public function updateTransaction(Request $request)
    {
        ...
        return redirect()->route('viewTransaction', ['id'=>$transaction->id])->with('success', 'Transaction is updated successfully.');
      }
      ...
      public function deleteTransaction(Request $request)
      {
        ...
        return redirect()->route('showAll')->with('success', 'Transaction is deleted successfully');
      }
}
